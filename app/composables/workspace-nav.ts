...
export const WORKSPACE_MODULES: WorkspaceModule[] = [
  ...
  { id: 'store', label: 'Store', icon: 'store', to: '/store', reveal: 's0', promise: 'Your storefront, wearing your brand — not ours.', why: 'The merchant is the hero; DOF is the gallery.' },
