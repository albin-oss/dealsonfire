/** POST /api/v1/products/:productId/options/:optionName/values — declare new values. */
import { getRouterParam } from 'h3'
import { defineCommandEndpoint } from '../../../../../../../utils/define-command-endpoint'
import { getContainer } from '../../../../../../../utils/container'
import { addOptionValuesRequest } from '@contracts/schemas/commerce/product.schema'
